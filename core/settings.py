...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-bs78(dl(c*se$qg!oj)&+h7%gm_0=qiyfyn#7vti^4(3c7dkhq')
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv('DB_NAME', 'bootcamp_db'),
...
# Azure Storage Configuration (when DEBUG=False)
if not DEBUG:
    ...
    STATICFILES_STORAGE = 'core.storage_backends.StaticAzureStorage'
    STATIC_URL = f'https://{AZURE_ACCOUNT_NAME}.blob.core.windows.net/{AZURE_CONTAINER}/'
    
    # Media files configuration for Azure
    DEFAULT_FILE_STORAGE = 'core.storage_backends.MediaAzureStorage'
...
DEFAULT_FROM_EMAIL = 'noreply@bootcamp.com'
SERVER_EMAIL = 'noreply@bootcamp.com'
...
# Internal IPs for Tailwind CSS development
INTERNAL_IPS = [
    "127.0.0.1",
    "localhost",
]
